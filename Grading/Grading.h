...
namespace mpcs51044 {
	...
	struct Abstract_student_info { // In header  
		...
		// Because the dynamic type call the destructor of its static type.
		// We need to make the destructor virtual to prevent memory leak.

		// Add a virtual destructor here.
		virtual ~Abstract_student_info() = default;
